...
const signals = [
  ...
  ["Критика или несогласие переживаются как личное отвержение.", "Но люди как будто специально собираются, чтобы показать вам, как они с вами не согласны."],
  ...
  return (
    <main>
      ...
      <section className="final-cta">
        ...
        <div><h2>Услышать, на что вы действительно <em>можете опереться.</em></h2><p>Вместе в Telegram мы свяжемся с вами, обсудим, подойдёт ли вам этот тренинг, и расскажем его детали. Для дальнейшей коммуникации понадобится подписаться на чат-бот в Telegram или в VK.</p><div className="final-meta">Москва, 3-5 сентября 2026</div><a className="button gold" href={BOT_URL} target="_blank" rel="noreferrer">Оставить заявку <ArrowIcon /></a></div>
      </section>
