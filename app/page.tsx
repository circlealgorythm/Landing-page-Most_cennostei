...
const APPLICATION_NOTE = "При оставлении заявки вы сможете подписаться на чат-бот, где узнаете подробнее о программе и получите бесплатный видео-шаг о том, через какие механизмы работает Ведический коучинг. Также мы с вами обязательно свяжемся, чтобы разобраться, подойдёт ли вам тренинг и сможет ли он решить ваши задачи.";
